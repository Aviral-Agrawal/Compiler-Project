    ...
    while(1)
      {
		...
		for(i=0;i<MAX_LEX_LEN;i++)
            ...
            case 404:
                ...
                {
                    printf("Line %d: Record field identifier is longer than the prescribed length of 20 characters\n", t->lineNo);
                    t->tkType = TK_ERROR;
                    t->lineNo = curLine;
                    t->lexeme[curLexeme++] = '\0';
                    buffPos--;
                ...
                {
                    printf("Line %d: Function is longer than the prescribed length of 30 characters\n", t->lineNo);
                    t->tkType = TK_ERROR;
                    t->lineNo = curLine;
                    t->lexeme[curLexeme++] = '\0';
                    buffPos--;
